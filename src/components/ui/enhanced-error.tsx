...
import { createErrorInfo } from './error-info';
import type { ErrorInfo as UiErrorInfo } from './error-info';
...
// Use the ErrorInfo type from `error-info.ts` for the prop shapes
type ErrorInfo = UiErrorInfo;
...
// `createErrorInfo` is provided from `error-info.ts` and imported above.
